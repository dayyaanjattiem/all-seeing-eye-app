...
if features_df.empty:
    st.error("Cannot proceed. No valid data for analysis after cleaning.")
    st.stop()
...
report_df['Debt/Equity'] = features_clustered_df['Debt_to_Equity']
...
if not index_df.empty:
    ...
    with col_corr1:
        fig_corr = plot_correlation_beta(normalized_df, SHARIA_INDEX)
        st.pyplot(fig_corr)
    ...
    st.warning("Could not fetch data for Correlation/Beta analysis.")